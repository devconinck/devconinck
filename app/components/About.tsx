  ...
  return (
    <div className="min-h-screen  flex items-center justify-center p-4">
      <motion.div
        ...
        className="max-w-6xl w-full  rounded-2xl shadow-xl overflow-hidden"
      >
        <div className="md:flex">
          ...
          >
            ...
            <p className="pt-8 max-w-2xl text-xl ">
              Applied Information Technology student specializing in{" "}
